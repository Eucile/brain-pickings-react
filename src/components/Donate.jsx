...
function Donate(){
  return(
      ...
      <h4><strong>MONTHLY DONATION</strong></h4>
      ...
      <h4><a href="https://www.brainpickings.org/donate/">START NOW</a></h4>

      <h4><strong>ONE-TIME DONATION</strong></h4>

			<p>You can also become a Spontaneous Supporter with a one-time donation in any amount:</p>

			<h4><a href="https://www.brainpickings.org/donate/">GIVE NOW</a></h4>
