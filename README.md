...
This project is an extension of a former project I originally made in Angular. It will be reconstituted and styled using JSX and the React library. The project is cloned off the online newsletter, [Brain Pickings](https://www.brainpickings.org/) using TypeScript and angular components, but my plan now is to integrate it all into a React setting from scratch.
